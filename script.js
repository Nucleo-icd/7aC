document.getElementById('login-button').addEventListener('click', async function () {
  ...
  if (username === 'ambulatorio' && password === 'ambulatorio') {
    ...
    window.location.href = "https://app.powerbi.com/view?r=eyJrIjoiZTg2MzBmNWYtYmVjMS00MDkxLWE0NDQtMGQ2ZTA3MDg2MzRmIiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS08M2Q1LTE5MGE2Y2MwMTM2NSJ9";
  } else {
